...
function EnrollmentsReportPage() {
  ...
  return (
    <div>
      <div>
        <h2>Course Enrolment Report 1</h2>
        <p>
          This page contain instant search feature, and you can sort the data by
...
export default EnrollmentsReportPage;
